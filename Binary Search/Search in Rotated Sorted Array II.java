...
Solution: 
	...
	分析： 这道题是二分查找Search Insert Position的变体，思路在Search in Rotated Sorted Array中介绍过了，不了解的朋友可以先看看那道题哈。
    ...
    public boolean search(int[] nums, int target) {
        ...
        while (start + 1 < end) {
            ...
            if (nums[mid] < nums[end]) {
                ...
                start++; //当nums[start] == nums[mid] == nums[end] 时， 不知道该跳向哪一半，把边缘向中间挪动一步
                end--;	// 当任意两个相等的时候，因为前面检测过也可以把边缘向中间挪动一步
            }
        }
